<div class="card border-0 rounded-top shadow-sm overflow-hidden">
    <div class="card-header align-items-center">
        <div class="row">
            <div class="col d-flex align-items-center">
                <div class="d-flex align-items-center font-weight-medium py-1">
                    <div class="d-flex align-items-center text-truncate">
                        <a href="{{ route('runway.text.show', $image->id) }}" class="text-body text-truncate">{{ $image->name }}</a>
            ...
            <div class="col-auto">
                <div class="form-row">
                    <div class="col">
                        <a href="{{ route('runway.text.show', $image->id) }}" class="btn btn-sm d-flex align-items-center" data-tooltip="true" title="{{ __('View') }}">
                            @include('icons.eye', ['class' => 'fill-current width-4 height-4 text-secondary'])&#8203;
                        </a>
                    </div>
                    <div class="col">
                        <a href="{{ route('runway.text.edit', $image->id) }}" class="btn btn-sm d-flex align-items-center" data-tooltip="true" title="{{ __('Edit') }}">
    ...
    <div class="card-footer text-muted small">
        <div class="row">
            <div class="col-auto">
                <div data-tooltip="true" title="{{ __('Resolution') }}"></div>
            </div>
        </div>
    </div>
</div>
