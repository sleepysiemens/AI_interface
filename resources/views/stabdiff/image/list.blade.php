...
<div class="d-flex">
    <div class="flex-grow-1">
        <h1 class="h2 mb-3 d-inline-block">{{__('Stabdiff')}} {{ __('Generate by image') }}</h1>
    </div>
    <div>
        <a href="{{ route('stabdiff.image.new') }}" class="btn btn-primary mb-3">{{ __('New') }}</a>
    </div>
</div>
...
<div class="card border-0 shadow-sm">
    <div class="card-header align-items-center">
        <div class="row">
            ...
            <div class="col-auto">
                <form method="GET" action="{{ route('stabdiff.image') }}">
                            ...
                            <div class="dropdown-menu {{ (__('lang_dir') == 'rtl' ? 'dropdown-menu' : 'dropdown-menu-right') }} border-0 shadow width-64 p-0" id="search-filters">
                                <div class="dropdown-header py-3">
                                    <div class="row">
                                        ...
                                        <div class="col-auto"><a href="{{ route('stabdiff.image') }}" class="text-secondary">{{ __('Reset') }}</a></div>
                                    </div>
                                </div>
                    ...
                    <div class="list-group-item px-0">
                        <div class="row align-items-center">
                                        ...
                                        <div class="text-truncate">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex align-items-center text-truncate">
                                                    <a href="{{ route('stabdiff.image.show', $image->id) }}" class="text-truncate">{{ $image->name }}</a>
                            ...
                            <div class="col-auto">
                                <div class="form-row">
                                    <div class="col">
                                        @include('stabdiff.image.partials.menu')
                                    </div>
                                </div>
                            </div>
                        </div>
