...
<div class="card border-0 shadow-sm overflow-hidden">
    <div class="card-body p-5">
        <div class="h-100 d-flex flex-column justify-content-center align-items-center my-6">
            ...
            <div>
                <h5 class="mt-4 text-center">{{ __('Ваш сайт успешно установлен!') }}</h5>
                <p class="text-center text-muted mb-0">{!! __('Вы большой молодец, сделали все правильно. Благодарим за выбор нашего скрипта.', ['name' => '<span class="font-weight-medium">'.config('info.software.name').'</span>']) !!}</p>
            </div>
        </div>
    </div>
</div>
