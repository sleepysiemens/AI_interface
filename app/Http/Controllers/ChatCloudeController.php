...
use App\Traits\ChatCloudeTrait;
use Carbon\Carbon;
...
class ChatCloudeController extends Controller
{
    use ChatCloudeTrait;
    ...
    public function index(Request $request)
    {
        ...
        return view('cloude_chats.container', ['view' => 'list', 'chats' => $chats]);
    }
    ...
    {
        return view('cloude_chats.container', ['view' => 'new']);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('cloude_chats.container', ['view' => 'edit', 'chat' => $chat]);
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('cloude_chats.container', ['view' => 'show', 'chat' => $chat, 'messages' => $messages]);
    }
    ...
    public function store(StoreChatRequest $request)
    {
        ...
        return redirect()->route('chats.cloude')->with('success', __(':name has been created.', ['name' => $request->input('name')]));
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        return redirect()->route('chats.cloude')->with('success', __(':name has been deleted.', ['name' => $chat->name]));
    }
