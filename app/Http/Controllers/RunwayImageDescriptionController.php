...
use App\Traits\RunwayImageDescriptionTrait;
use GuzzleHttp\Client;
use Illuminate\Http\Request;

class RunwayImageDescriptionController extends Controller
{
    use RunwayImageDescriptionTrait;
    ...
    public function index(Request $request)
    {
        ...
        $images = Runway::where('user_id', $request->user()->id)->where('type','image_description')
        ...
        return view('runway.image_description.container', ['view' => 'list', 'images' => $images]);
    }
    ...
    {
        return view('runway.image_description.container', ['view' => 'new']);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('runway.image_description.container', ['view' => 'edit', 'image' => $image]);
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('runway.image_description.container', ['view' => 'show', 'image' => $image, 'link' => $link]);
    }
    ...
    public function store(StoreImageRequest $request)
    {
        ...
        return redirect()->route('runway.image_description.show', $image);
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        return redirect()->route('runway.image')->with('success', __(':name has been deleted.', ['name' => $image->name]));
    }
}
