...
use App\Traits\RunwayImageTrait;
use GuzzleHttp\Client;
use Illuminate\Http\Request;

class RunwayImageController extends Controller
{
    use RunwayImageTrait;
    ...
    public function index(Request $request)
    {
        ...
        $images = Runway::where('user_id', $request->user()->id)->where('type','image')
        ...
        return view('runway.image.container', ['view' => 'list', 'images' => $images]);
    }
    ...
    {
        return view('runway.image.container', ['view' => 'new']);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('runway.image.container', ['view' => 'edit', 'image' => $image]);
    }
    ...
    public function store(StoreImageRequest $request)
    {
        ...
        return redirect()->route('runway.image.show', $image);
    }
