...
use App\Traits\StabDiffImageTrait;
use App\Traits\StabDiffTextTrait;
use Illuminate\Http\Request;

class StabDiffImageController extends Controller
{
    use StabDiffImageTrait;
    ...
    public function index(Request $request)
    {
        ...
        return view('stabdiff.image.container', ['view' => 'list', 'images' => $images]);
    }
    ...
    {
        return view('stabdiff.image.container', ['view' => 'new']);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('stabdiff.image.container', ['view' => 'edit', 'image' => $image]);
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('stabdiff.image.container', ['view' => 'show', 'image' => $image]);
    }
    ...
    public function store(StoreImageRequest $request)
    {
        ...
        return view('stabdiff.image.container', ['view' => 'new', 'images' => $images, 'name' => $request->input('name'), 'description' => $request->input('description'), 'style' => $request->input('style'), 'medium' => $request->input('medium'), 'filter' => $request->input('filter'), 'resolution' => $request->input('resolution'), 'variations' => $request->input('variations')]);
    }
